...
![Dashboard](frontend/assets/ui-home.png)

### Step 1 — Provide Input (Manual + JSON Upload)
![Step 1](frontend/assets/UI_Home_Step1_Provide_Input.png)

### Step 2 — Predict (Response + Latency)
